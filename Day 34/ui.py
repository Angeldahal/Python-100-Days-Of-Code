...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.window.config(bg = THEME_COLOR, height = 900, width = 800, padx = 20, pady = 20)

        self.score_label = Label(text = f"Score:", bg = THEME_COLOR, fg= "white")
        self.score_label.grid(row = 0, column = 1)

        self.canvas = Canvas(height = 500, width = 500, bg = "White")
        self.question_text = self.canvas.create_text(250, 250, width = 300,text = "Some Question Text", font = ("Arial", 20, "italic"))
